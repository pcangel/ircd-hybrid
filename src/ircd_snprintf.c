...
/*! \file ircd_snprintf.c
 * \brief IRC-specific printf() clone implementation.
 * \version $Id: ircd_snprintf.c 1011 2009-09-18 10:14:09Z michael $
 */
 ...
 */
static void
doprintf(void *dest, struct BufData *buf_p, const char *fmt, va_list vp)
{
  enum {
...
int
ircd_snprintf(void *unused, char *buf, size_t buf_len, const char *format, ...)
{
  struct BufData buf_s = BUFDATA_INIT;
  va_list args;
  ...
  doprintf(unused, &buf_s, format, args); /* fill the buffer */
  va_end(args);
 ...
 */
int
ircd_vsnprintf(void *unused, char *buf, size_t buf_len, const char *format, va_list args)
{
  struct BufData buf_s = BUFDATA_INIT;
