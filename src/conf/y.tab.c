...
{
  "$end", "error", "$undefined", "BOOL", "BYTES", "DAYS", "HOURS",
  "KBYTES", "MBYTES", "NUMBER", "IDENTIFIER", "MINUTES", "QSTRING",
  "SECONDS", "WEEKS", "'{'", "'}'", "';'", "','", "'.'", "'='", "$accept",
  "conf", "conf_block", "@1", "timespec_", "timespec", "sizespec_",
  "sizespec", "ident_list_atom", "ident_list", "number_atom",
  "number_range", "number_item", "number_items", "number_list",
  "conf_items", "conf_item", "@2", "value", "default_field",
  "_default_field", "@3", 0
};
#endif
...
#line 100 "parser.y"
    {
  if ((conf_current_section = find_conf_section((yyvsp[(1) - (1)].string))) != NULL)
  {
...
#line 125 "parser.y"
  ...
  case 12:
#line 126 "parser.y"
    { (yyval.number) = (yyvsp[(1) - (3)].number)*3600 + (yyvsp[(3) - (3)].number); }
    break;

  case 13:
#line 127 "parser.y"
    { (yyval.number) = (yyvsp[(1) - (3)].number)*86400 + (yyvsp[(3) - (3)].number); }
    break;

  case 14:
#line 128 "parser.y"
    { (yyval.number) = (yyvsp[(1) - (3)].number)*604800 + (yyvsp[(3) - (3)].number); }
    break;
...
#line 132 "parser.y"
  ...
  case 19:
#line 133 "parser.y"
    { (yyval.number) = (yyvsp[(1) - (3)].number)*1048576 + (yyvsp[(3) - (3)].number); }
    break;

  case 20:
#line 135 "parser.y"
    { conf_add_ident((yyvsp[(1) - (1)].string)); }
    break;

  case 23:
#line 143 "parser.y"
    { conf_add_number((yyvsp[(1) - (1)].number)); }
    break;
...
#line 145 "parser.y"
  ...
  if ((yyvsp[(4) - (4)].number) - (yyvsp[(1) - (4)].number) < 0 || (yyvsp[(4) - (4)].number) - (yyvsp[(1) - (4)].number) >= 100)
    yyerror("invalid range");
  else for (i = (yyvsp[(1) - (4)].number); i <= (yyvsp[(4) - (4)].number); i++)
    conf_add_number(i);
}
    break;
...
#line 164 "parser.y"
    {
  conf_field = find_conf_field(conf_current_section, (yyvsp[(1) - (1)].string));
}
    break;
...
#line 170 "parser.y"
    {
         conf_assign(CT_STRING, conf_field, (yyvsp[(1) - (1)].string));
       }
    break;
...
#line 172 "parser.y"
    {
         conf_assign(CT_NUMBER, conf_field, &(yyvsp[(1) - (1)].number));
       }
    break;
...
#line 174 "parser.y"
    {
         conf_assign(CT_BOOL, conf_field, &(yyvsp[(1) - (1)].number));
       }
    break;
...
#line 176 "parser.y"
    {
         conf_assign(CT_TIME, conf_field, &(yyvsp[(1) - (1)].number));
       }
    break;
...
#line 178 "parser.y"
    {
         conf_assign(CT_SIZE, conf_field, &(yyvsp[(1) - (1)].number));
       }
    break;
